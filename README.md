...
For the production environment, the API documentation is available at [here](http://load-balancer-production-866833777.ap-southeast-2.elb.amazonaws.com/docs)
